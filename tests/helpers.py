...
def post_data(flask_test_client, endpoint: str, post_data: dict):
    ...
    flask_test_client.post(endpoint, data=json.dumps(post_data), content_type='application/json')


def count_fund_applications(test_client, fund_name: str, expected_application_count):
    """
    ...
    Args:
        ...
        expected_application_count (int): The expected number of applications within the fund
