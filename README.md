...
if --single_application is Flagged.

  ### Run locally
  - Example command without Flags --single_application and --send_email

    `python -m scripts.send_application_on_closure --fund_id 47aef2f5-3fcb-4d45-acb5-f0152b5f03c4 --round_id e85ad42f-73f5-4e1b-a1eb-6bc5d7f3d762`

  - Example command with Flags --single_application and --send_email

    `python -m scripts.send_application_on_closure --fund_id 47aef2f5-3fcb-4d45-acb5-f0152b5f03c4 --round_id e85ad42f-73f5-4e1b-a1eb-6bc5d7f3d762 --application_id 2ad3c0e5-ad9b-4dfb-ab95-95a758f73cba --single_application --send_email`

   ### Run with docker
   - Example command without Flags --single_application and --send_email

     `docker exec -ti $(docker ps -qf "name=application-store") scripts/send_application_on_closure.py --fund_id 47aef2f5-3fcb-4d45-acb5-f0152b5f03c4 --round_id 6af19a5e-9cae-4f00-9194-cf10d2d7c8a7`

   - Example command with Flags --single_application and --send_email

     `docker exec -ti $(docker ps -qf "name=application-store") scripts/send_application_on_closure.py --fund_id 47aef2f5-3fcb-4d45-acb5-f0152b5f03c4 --round_id 6af19a5e-9cae-4f00-9194-cf10d2d7c8a7 --application_id 2ad3c0e5-ad9b-4dfb-ab95-95a758f73cba --single_application --send_email`

   ### Run on Cloud Foundry

   - Example command without Flags --single_application and --send_email

      `cf run-task funding-service-design-application-store-test --command "python -m scripts.send_application_on_closure --fund_id 47aef2f5-3fcb-4d45-acb5-f0152b5f03c4 --round_id 6af19a5e-9cae-4f00-9194-cf10d2d7c8a7`

    - Example command with Flags --single_application and --send_email

      `cf run-task funding-service-design-application-store-test --command "python -m scripts.send_application_on_closure --fund_id 47aef2f5-3fcb-4d45-acb5-f0152b5f03c4 --round_id 6af19a5e-9cae-4f00-9194-cf10d2d7c8a7 --application_id 2ad3c0e5-ad9b-4dfb-ab95-95a758f73cba --single_application --send_email`
