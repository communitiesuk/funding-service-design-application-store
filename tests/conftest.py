...
@pytest.fixture(scope="function")
def seed_data_multiple_funds_rounds(request, mocker, app, clear_test_data, enable_preserve_test_data, flask_test_client):
    """
    ...
    for fund in config["funds"]:
        ...
        for round in fund["rounds"]:
            ...
            for appl in round["applications"]:
                ...
                application_ids.append(str(created_app.id))
